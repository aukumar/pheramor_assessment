...
public class SummaryActivity extends AppCompatActivity {
   ...
   // TextView email;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        picture.setImageURI(ProfilePictureActivity.uri);
        ...
        height.setText("Height: "+newUser.getHeight()+" cm");

        SimpleDateFormat df = new SimpleDateFormat("yyyy");
        String year = df.format(newUser.getDob());
        int age = 2018-Integer.parseInt(year);

        gender.setText("Gender,Age: "+newUser.getGender()+", "+age);

        interest.setText("Looking for "+newUser.getInterests()+" from age "+newUser.getFrom_age()+" to "+newUser.getTo_age());
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(SummaryActivity.this,"Succesfully registered",Toast.LENGTH_SHORT).show();
